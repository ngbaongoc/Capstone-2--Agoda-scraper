import argparse #allow to interact with the program by typing text commands in to a terminal or a command prompt
import logging #allow user to see what's happening 
import os
...
def main():
    ...
    args = parser.parse_args() #Tell the parser to read and check user's command line
    output_path = args.output #Tell the script to save the JSON later on 

    # Ensure output directory exists
    os.makedirs(os.path.dirname(output_path), exist_ok=True) #Ensure output exists
